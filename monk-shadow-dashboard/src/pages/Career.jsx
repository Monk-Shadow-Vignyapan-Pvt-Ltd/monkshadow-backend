    ...
    return (
        <>
            ...
            {isLoading ?
                ...
                :
                <div className="mx-auto w-full flex flex-col col-span-12 md:col-span-8 bg-cardBg dark:bg-[#141414] dark:text-[#e6e6e6] flex-1 p-5 gap-6">
                    ...
                    >
                        ...
                        <div className="flex flex-col gap-1">
                            ...
                            <input
                                ...
                                className="bg-mainBg placeholder:text-secondaryText dark:bg-black focus:outline-accent text-sm rounded-lg px-3 py-2 block w-full flatpickr-input"
                            />
                        </div>
                        <div className="flex flex-col gap-1">
                        ...
                        <div className="grid grid-cols-2 gap-3 m-x-4 w-full">
                            <button
                                ...
                                className={`px-6 py-2 rounded-lg text-cardBg text-md font-medium duration-300 ${editingCareer
                            ...
                            <button onClick={closeModal} className="px-6 py-2 rounded-lg font-medium text-md text-cardBg bg-dangerRed hover:bg-dangerRed/75 dark:bg-[#4d1a19] duration-300">
                                Cancel
                            </button>
                        </div>
                    </Modal>

                    <div className="overflow-hidden border-2 dark:border-[#2b2b2b] rounded-lg lg:w-[calc(100vw-300px)]">
                        {/* DataTable Component */}
                        <DataTable
                            columns={columns}
