import getContactFollowupModel from "../models/contact_followup.model.js";

// Add a new follow-up
export const addFollowup = async (req, res) => {
  try {
    const region = req.baseUrl.includes("/canada") ? "canada" : "india";
    const ContactFollowup = getContactFollowupModel(region);
    ...
    const followup = new ContactFollowup({ contactId, status, followupMessage });
